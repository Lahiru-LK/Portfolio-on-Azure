...
const IconButton = ({ Icon, to, external }) => {
  const Wrapper = external ? 'a' : ScrollLink;
  const props = external
    ? { href: to, target: '_blank', rel: 'noopener noreferrer' }
    : { to, smooth: true, duration: 500 };

  return (
    <Wrapper {...props} className="cursor-pointer group">
            ...
            <div className="w-full max-w-4xl mx-auto">
              ...
              >
                <div data-aos="fade-down" data-aos-delay="0">
                  <IconButton Icon={Code2} to="Portofolio" />
                </div>
                <div data-aos="fade-down" data-aos-delay="200">
                  <IconButton Icon={User} to="About" />
                </div>
                <div data-aos="fade-down" data-aos-delay="400">
                  <IconButton Icon={Github} to="https://github.com/Lahiru-LK" external />
                </div>
              </motion.div>
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="www.lahiruprasad.me" />
                    </span>
                  </div>
                </a>
              </motion.div>
