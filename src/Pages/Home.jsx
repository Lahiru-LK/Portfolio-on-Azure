...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0 pl-64" data-aos="zoom-in" data-aos-delay="400">
...
const WORDS = ["Full Stack Developer", "Software Engineering Student", "Tech Enthusiast", "Freelancer"];
const TECH_STACK = ["React", "Node.js", "Tailwind", "Java", "Python", "C#", ".NET", "SQL"];

const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Lahiru-LK" },
  { icon: Linkedin, link: "www.linkedin.com/in/lahiruprasadlk" },
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Passionate Full Stack Developer focused on building secure, scalable, and visually engaging digital solutions. Driven to innovate and committed to continuous learning across frontend and backend technologies.
                </p>
