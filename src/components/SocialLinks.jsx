...
import { Facebook, FiberDvrRounded, WhatsApp, } from "@mui/icons-material";
...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/lahiruprasadlk",
    color: "#0A66C2",
...

  {
    ...
    subText: "Lahiru-LK",
    icon: Github,
    url: "https://github.com/Lahiru-LK",
    color: "#ffffff",
...

  {
    ...
    subText: "@lk_lahiru",
    icon: SiFiverr, // 
    url: "https://www.fiverr.com/lk_lahiru?public_mode=true",
    color: "#1DBF73",
    gradient: "from-[#1DBF73] to-[#0AA66E]"
  },
  {
    name: "Whatsapp",
    ...
    subText: "Lahiru LK",
    icon: WhatsApp,
    url: "https://wa.me/message/KRWP3YEGRFLIK1",
    color: "#1DBF73",
    gradient: "from-[#1DBF73] to-[#0AA66E]"
  },

  {
    ...
    subText: "Lahiru LK",
    icon: Facebook,
    url: "https://www.facebook.com/share/16Hztmn3vh",
    color: "#1877F2",
    gradient: "from-[#1877F2] via-[#1F4EED] to-[#1F56ED]"
  },
